...
public class StaffRVAdapter extends RecyclerView.Adapter<StaffRVAdapter.ViewHolder> {
    ...
    public StaffRVAdapter(Context context, List<StaffMovieModel> staffModelList) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view, final Context context) {
            ...
            movieImage = (CircularImageView)view.findViewById(R.id.img_staff_face);
